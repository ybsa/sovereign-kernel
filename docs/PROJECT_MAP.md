...
├── config/                       # Example configuration files (sandbox, unrestricted)
...
│   ├── sk-hands/                 # Grimoires/Hands: Pre-configured Agent packages (otto, clip, etc.)
...
│   ├── ARCHITECTURE.md           # System architecture design and data flows
│   ├── PROJECT_MAP.md            # (This File) Lore definitions and directory structure
│   └── PROJECT_PLAN.md           # Historical project implementation roadmap
