...
use crate::runtime::web_cache::WebCache;
use crate::runtime::web_content::wrap_external_content;
use sk_types::config::{SearchProvider, WebConfig};
use std::sync::Arc;
...
pub struct WebToolsContext {
    ...
    pub fetch: crate::runtime::web_fetch::WebFetchEngine,
}
...
impl WebSearchEngine {
    ...
    async fn search_duckduckgo(&self, query: &str, max_results: usize) -> Result<String, String> {
        ...
        let resp = self
            ...
            .header(
                "User-Agent",
                "Mozilla/5.0 (compatible; Sovereign KernelAgent/0.1)",
            )
            .send()
            .await
